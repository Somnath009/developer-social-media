    ...
    return (
        ...
        >
            <div className="w-full">
                <img
                    onClick={() => navigate("/")}
                    className="cursor-pointer w-26 ml-7 my-2"
                    src={assets.logo}
                    alt=""
                />
            ...
            <div className="w-full border-t border-gray-200 p-4 px-7 flex items-center justify-between">
                ...
                <LogOut onClick={() => signOut()} className="w-5 h-5 text-gray-500 hover:text-gray-700 hover:-translate-y-0.5 transition-transform" />
            </div>
